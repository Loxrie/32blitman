...
static std::array<LevelData, 21> level_data = {
  (LevelData){0, 100, 0.8f, 0.71f, 0.90f, 0.79f, 0.75f, 0.40f, 0.55f, 6000, 1100}, // 1
  (LevelData){1, 300, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 5000, 1100}, // 2
  (LevelData){2, 500, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 4000, 1100}, // 3
  (LevelData){2, 500, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 3000, 1100}, // 4
  (LevelData){3, 700, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 5
  (LevelData){3, 700, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 5000, 1100}, // 6
  (LevelData){4,1000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 7
  (LevelData){4,1000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 8
  (LevelData){5,2000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 9
//(LevelData) bi, bp, pms,  pmds,  pmfs,  pmfds,  gs,   gts,   gfs,   ft,   fwt
  (LevelData){5,2000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 5000, 1100}, // 10
  (LevelData){6,3000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 11
  (LevelData){6,3000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 12
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 13
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 3000, 1100}, // 14
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 15
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 17
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 18
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 19
  (LevelData){7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 20
  (LevelData){7,5000, 0.9f, 0.79f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0}        // 21
};
