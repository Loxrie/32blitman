...
static std::vector<LevelData> level_data = {
  {0, 100, 0.8f, 0.71f, 0.90f, 0.79f, 0.75f, 0.40f, 0.55f, 6000, 1100}, // 1
  {1, 300, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 5000, 1100}, // 2
  {2, 500, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 4000, 1100}, // 3
  {2, 500, 0.9f, 0.79f, 0.95f, 0.83f, 0.85f, 0.45f, 0.55f, 3000, 1100}, // 4
  {3, 700, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 5
  {3, 700, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 5000, 1100}, // 6
  {4,1000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 7
  {4,1000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 8
  {5,2000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 9
// bi, bp, pms,  pmds,  pmfs,  pmfds,  gs,   gts,   gfs,   ft,   fwt
  {5,2000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 5000, 1100}, // 10
  {6,3000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 2000, 1100}, // 11
  {6,3000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 12
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 13
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 3000, 1100}, // 14
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 15
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 17
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 1000, 700},  // 18
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 19
  {7,5000, 1.0f, 0.87f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 20
  {7,5000, 0.9f, 0.79f, 1.00f, 0.87f, 0.95f, 0.50f, 0.60f, 0, 0},       // 21
};
