...
void init() {
  ...
  map.layers["background"].add_flags({61, 62}, entityType::JUNCTION);
  map.layers["background"].add_flags(62, entityType::NU_JUNCTION);
  map.layers["background"].add_flags({0,61,62}, entityType::NOTHING);
  // Set pills.
